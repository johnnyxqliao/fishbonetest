...
function(a) {
    ...
    function c(c) {
        ...
        this.remove = function(a) {
            if (null == a)
                throw new Error("Stage.remove³ö´í: ²ÎÊýÎªnull!");
            for (var b = 0; b < this.childs.length; b++)
                if (this.childs[b] === a)
                    return a.stage = null,
...
function(a) {
    function b(c) {
        ...
        this.paintAlarmText = function(a) {
            if (null != this.alarm && "" != this.alarm) {
                var b = this.alarmColor || "255,0,0"
                  , c = this.alarmAlpha || .5;
                a.beginPath(),
                a.font = this.alarmFont || "10px Î¢ÈíÑÅºÚ";
                var d = a.measureText(this.alarm).width + 6
                  , e = a.measureText("Ìï").width + 6
                  , f = this.width / 2 - d / 2
                  , g = -this.height / 2 - e - 8;
        ...
        this.setImage = function(a, b) {
            if (null == a)
                throw new Error("Node.setImage(): ²ÎÊýImage¶ÔÏóÎª¿Õ!");
            var c = this;
            if ("string" == typeof a) {
                var d = j[a];
                null == d ? (d = new Image,
                ...
                ) : (b && this.setSize(d.width, d.height),
                c.image = d,
                c.alarmColor = null == c.alarmColor ? "255,0,0" : c.alarmColor)
            } else
                this.image = a,
    ...
    function d(a) {
        ...
        this.paint = function(a) {
            ...
            this.height = a.measureText("Ìï").width,
            a.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")",
            a.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")",
